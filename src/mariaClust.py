...
class MariaClust:
	...
	def plot_clusters(self, cluster_points, set_de_date, color_list):
		...
		fig.savefig('F:\\IULIA\\GITHUB_MARIACLUST\\MariaClust\\results\\poze2\\MARIACLUST'+'_'+str(set_de_date)+'.png')   # save the figure to file
		plt.close(fig)
...
if __name__ == "__main__":
	...
	color_list = mariaClustInstance.return_generated_colors()
	mariaClustInstance.plot_clusters(cluster_points, set_de_date, color_list)